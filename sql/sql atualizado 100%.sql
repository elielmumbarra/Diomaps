...
--
-- Host: 127.0.0.1
-- Tempo de geração: 24-Nov-2023 às 21:32
...
CREATE TABLE `noticia` (
  ...
  `descriçãoimagem` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- --------------------------------------------------------

--
-- Estrutura da tabela `tiposdelixo`
--
...
--
-- Extraindo dados da tabela `tiposdelixo`
--
...
INSERT INTO `usuario` (`id`, `nome`, `email`, `senha`, `cep`, `endereço`, `bairro`, `telefone`, `lixo`, `nivel`) VALUES
...
--
-- Índices para tabela `tiposdelixo`
--
ALTER TABLE `tiposdelixo`
  ADD PRIMARY KEY (`id`);
