-- DIOMAPS - Dump para phpMyAdmin (UTF8MB4)
-- Dica: no phpMyAdmin -> Importar -> escolher este arquivo -> Charset do arquivo: UTF-8
...
-- 1) Banco
-- =====================================================================
-- phpMyAdmin (hospedagem) frequentemente bloqueia CREATE DATABASE (erro #1044).
-- Portanto: crie/seleciona o banco manualmente no phpMyAdmin e depois importe este arquivo.
-- Exemplo de nome comum em hospedagem: if0_40899908_diomaps

-- CREATE DATABASE IF NOT EXISTS `diomaps`
--   CHARACTER SET utf8mb4
--   COLLATE utf8mb4_unicode_ci;

-- IMPORTANTE: selecione o banco correto no phpMyAdmin antes de importar
-- USE `diomaps`;

-- =====================================================================
-- 2) Limpeza (reimport sem erro)
-- =====================================================================
...
DROP TABLE IF EXISTS `tiposdelixo`;
...
-- =====================================================================
-- 6) Views (compatibilidade)
-- =====================================================================
CREATE VIEW `v_bairros` AS
SELECT `idbairro` AS `id`, `nome` AS `name`
FROM `bairros`;
