...
<div class="gtranslate_wrapper"></div>       
    ...
    <div class="nav-pesquisa">
        <form method="POST" action="" class="pesq-title-cont">
                ...
                <input type="text" name="nome_usuario" id="nome_usuario" placeholder="Digite seu bairro"
                ...
                <details>
                    ...
                    <div class="filtro-cont">
                        <ul class="overflow-cont">
                            <?php
                            // Removido require/exec duplicados; usa $pdo já configurado
    ...
    <div id="container-geral">
        <section>
            ...
            if (empty($dados['pesqUsuario'])) {
                ...
                <img src="../imgs/pesq.png" style="width:40px;">
                Pesquise um posto
                </div>
                ';
            }
            ...
            if (!empty($dados['pesqUsuario'])) {
                ...
                $query_usuario = "SELECT id, nome, cep, bairro, endereco, telefone, imagem, lixo, nivel FROM usuario WHERE nome LIKE :nome";
            ...
            if ($result_usuarios->rowCount() == 0) {
                ...
                <div style="display:flex; flex-direction:column; align-items:center;">
                <img src="../imgs/closesearch.png" style="width:40px;">
